...
namespace 结合EF框架的订单窗口 {
    ...
    public partial class ordersDataSet : global::System.Data.DataSet {
        ...
        public partial class ordersDataTable : global::System.Data.TypedTableBase<ordersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ordersRow AddordersRow(string CustomerName) {
...
namespace 结合EF框架的订单窗口.ordersDataSetTableAdapters {
    ...
    public partial class ordersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `orders` WHERE ((`OrderID` = @p1))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `orders` (`CustomerName`) VALUES (@p1)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `orders` SET `CustomerName` = @p1 WHERE ((`OrderID` = @p2))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::结合EF框架的订单窗口.Properties.Settings.Default.ordersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `OrderID`, `CustomerName` FROM `orders`";
